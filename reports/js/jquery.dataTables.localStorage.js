...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			/*
			 * Variable: bLocalStorage
			 * Purpose:  If enabled, use browser localStorage in addition to cookie to save state
			 * Scope:    jQuery.dataTable.classSettings
			 */
		...
		function _fnSaveState ( oSettings )
		{
			...
			if ( oSettings.bLocalStorage == true ) 
			{
				var storKey = oSettings.sCookiePrefix+oSettings.sInstance;
				storKey = storKey.replace(/_/g, "-");
				localStorage.setItem( storKey, sValue );
			}
		}
		...
		function _fnLoadState ( oSettings, oInit )
		{
			...
			if ( oSettings.bLocalStorage == true && ( sData == null || sData == '' ) )
			{
				var storKey = oSettings.sCookiePrefix+oSettings.sInstance;
				storKey = storKey.replace(/_/g, "-");
				sData = localStorage.getItem( storKey );
			}
		...
		return this.each(function()
		{
			...
			if ( typeof oInit != 'undefined' && oInit !== null )
			{
				...
				_fnMap( oSettings, oInit, "bLocalStorage" );
